...
namespace Konstantin
    ...
    //! Рисует лужи
    //!
    //! В оределенных координатах на дороге рисуются три лужи разного размера.
    ...
    //!
    //! @note        Лужа рисуется в виде элипса и может увеличиваться и уменьшаться
    //!              При уменьшении лужи необходимо задать ее "начальный" размер,
    //!              чтобы она не уменьшилась меньше нуля и элипс не начался рисовать
